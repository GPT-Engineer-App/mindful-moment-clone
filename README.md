...
**Project**: mindful-moment-clone 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a clone of this website: hereandnowai.com 
...
```sh
git clone https://github.com/GPT-Engineer-App/mindful-moment-clone.git
cd mindful-moment-clone
npm i
